...
#target_cols = ['MetSIRS3_4hr_8', 'MetSIRS3_4hr_24', 'MetSIRS3_4hr_48']
...
#
#
# keep_inds =np.where((data['NoSIRS3_4hr_4']==1) | (data['MetSIRS3_4hr']==1))[0]
# data = data.iloc[keep_inds,:].reset_index(drop = True)
# features = features[keep_inds,:]

weights = np.ones((data.shape[0],1))
weights[np.where((data['SIRS4_3hr_Countdown']<=24) & (data['SIRS4_3hr_Countdown']>0))[0]] = 6
